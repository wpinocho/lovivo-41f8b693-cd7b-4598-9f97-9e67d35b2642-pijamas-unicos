...
export const EcommerceTemplate = ({
  ...
  const header = (
    <div className={`py-4 bg-background/95 backdrop-blur-sm border-b border-border ${headerClassName}`}>
  ...
  const footer = (
    <div className={`bg-gradient-to-b from-foreground to-foreground/95 text-background py-16 ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="mt-6 text-background/80 leading-relaxed">
              Creando momentos inolvidables entre padres e hijos, una pijama a la vez.
            </p>
          </div>

          {/* Links */}
          <div>
            <h3 className="font-bold mb-4 text-background">Enlaces</h3>
        ...
        <div className="mt-8 pt-8 border-t border-white/20 text-center text-white/70">
          <p>&copy; 2025 Sueños Compartidos. Creando recuerdos familiares desde 2025.</p>
        </div>
      </div>
    </div>
  )
